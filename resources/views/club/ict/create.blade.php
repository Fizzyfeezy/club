...
<html><head><style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}</style><!-- Bootstrap core CSS -->
  ...
  <title>ICT Club form</title>
</head>
<body class="container" ng-app="demoApp" ng-controller="MainCtrl as vm" style="overflow-x: hidden">
<div class="container text-center">
<h4>ICT Club Registration</h4>

<p><a href="https://lh3.googleusercontent.com/kUGo_RR3VjqWFlMsGUw-RfGLYdCmr30apMTn8-jaPWScWnrZyGtSYrLY4KLKybW7k41FbqS8iw=w200"><img alt="" src="{{asset('image/ict.jpg')}}" style="width: 100px; height: 100px;"></a></p>
<p><span style="font-size:16px;">The club aims to improve the ICT skills of its members by nurturing their creative and programming skills, and sharpening their research and presentation skills. The club also aims to promote innovation among its members as they seek out technological solutions to problems that may arise in a school environment.</span></p>

<p><span style="font-size:16px;"><strong>OBJECTIVES OF ICT CLUB</strong></span></p>

<p><span style="font-size:16px;"> To help students develop an appreciation for the role of ICT in today's society.<br>
 To guide members in computer ethics<br>
 To develop policies concerning the use of technology at school.<br>
 To improve members design skills.<br>
 To provide a fun and interactive approach to ICT.<br>
 To improve members' programming skills.<br>
 To raise awareness and promote the use of technology as a teaching/learning aid.<br>
 To improve members' internet authoring skills.<br>
 To help students develop as innovative beings who will see problems and create solutions.<br>
 To help other students become competent and confident users of ICT through training sessions.</span></p>

<p><span style="font-size:16px;"><strong>BENEFITS OF ICT CLUB</strong></span></p>
<p><span style="font-size:16px;"> Children are provided with a wealth of opportunities to engage in and develop their ICT skills. They enjoy the benefit of using the latest high quality technology and are given a wide variety of experiences by the time they leave us. ICT is taught not only as a subject, but also to enhance learning in other subjects.<br>

 Enthusiastic staff undertake regular training in order to keep abreast of current developments in ICT teaching. Children learn both independently and collaboratively, actively engaging in lessons using interactive whiteboards and the very latest exciting software.<br>

 ICT facilities include: Spacious air-conditioned computer site with interactive whiteboard, laser printers and safe internet access; Interactive whiteboards for each year group; Classroom computers with internet access and laser printers; Digital cameras and software; Modelling and control equipment; Sound recording equipment.<br>
 Red House believes that when children leave the Nursery and Infant School they will be equipped with the necessary ICT skills in order to progress to the next stage of their education..</span></p>
...
<form class="form-style shadow container" enctype="application/x-www-form-urlencoded" id="form-data" name="vm.form" ng-submit="vm.onSubmit()" novalidate="" style="height: 100%;" method="POST" action="{{route('icts.store')}}">
  {{ csrf_field() }}
...
<div class="col-xs-12 col-sm-6 col-md-6" ng-class="{'has-error': showError}"><label class="control-label " style="color: rgb(12, 12, 12)"><h3 id="amount" style="margin-top: 50px;">Payment : 7000</h3></label></div>
</div>
