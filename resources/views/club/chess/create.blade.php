...
<html><head><style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}</style><!-- Bootstrap core CSS -->
  ...
  <title>Chess Club form</title>
</head>
<body class="container" ng-app="demoApp" ng-controller="MainCtrl as vm" style="overflow-x: hidden">
<div class="container text-center">
<h4>Chess Club Registration</h4>

<p><a href="https://lh3.googleusercontent.com/kUGo_RR3VjqWFlMsGUw-RfGLYdCmr30apMTn8-jaPWScWnrZyGtSYrLY4KLKybW7k41FbqS8iw=w200"><img alt="" src="{{asset('image/chess.jpg')}}" style="width: 100px; height: 100px;"></a></p>
<p><span style="font-size:16px;">The game of chess holds a unique fascination. The strategic
complexities offer lively minds an immediate challenge and
stimulating exercise. It can be played for fun, or with increasing
degrees of seriousness up to the highest levels of international
competition.
</span></p>
<p style="font-size:16px;">Chess has many educational benefits, giving children intellectual
capital and transferable skills such as focus, discipline,
concentration, spatial awareness and strategic thinking. Save the
Children believe that “education is a key to improving the life
chances of children.......” and chess can be an integral part of that
education. Evidence clearly demonstrates that chess-playing
school pupils significantly outperform their non-playing
contemporaries in literacy, numeracy and problem solving skills.
Perhaps of greater importance is the fact that young chess
players become more confident, have enhanced self-esteem and
are more able to organise their thinking and behaviour. Providing
children with the opportunity to play chess is a gift they keep for
the rest of their lives. Chess is a sociable activity that helps to
bring children together and break down barriers, whilst at the
same time encouraging a healthy sense of competitiveness.</strong>.</p>

<p><span style="font-size:16px;"><strong>OBJECTIVES OF CHESS CLUB</strong></span></p>

<p><span style="font-size:16px;">Our chess club is open to all students, outsiders and even graduates or everybody who are willing to learn more about chess and play chess.
Our goals are:<br> To teach chess to interested persons.<br>
 To produce tournament competent players.<br>
 To join Chess tournaments all over the country.</span></p>

<p><span style="font-size:16px;"><strong>BENEFITS OF CHESS CLUB</strong></span></p>
<p><span style="font-size:16px;"> The game of chess helps young people learn to concentrate, think logically, overcome obstacles, spot patterns and categorize information.<br>
 It helps with the development of problem-solving skills, planning, patience, focus of thought and self-discipline.<br>
 Chess is a competitive activity, but , good sportsmanship and fair play are taught as essential elements of the game.<br>
 Chess is a one-against-one activity, however, teamwork is also an important element. This element comes into play when Club members must practice and work on problems together.<br>
 Everyone has a chance to contribute to the team in tournament play as chess clubs may enter as many players as they wish and various skill-levels or age-based sections are generally available.<br>
 A scholastic chess club provides a challenge for students while helping build confidence and self-esteem. It offers a combination of educational and social activity.</span></p>
...
<form class="form-style shadow container" enctype="application/x-www-form-urlencoded" id="form-data" name="vm.form" ng-submit="vm.onSubmit()" novalidate="" style="height: 100%;" method="POST" action="{{route('chesses.store')}}">
  {{ csrf_field() }}
