...
@section('title', '| Red-Cross Club Form' )
...
<html><head><style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}</style><!-- Bootstrap core CSS -->
  ...
  <title>Red-Cross Club form</title>
</head>
<body class="container" ng-app="demoApp" ng-controller="MainCtrl as vm" style="overflow-x: hidden">
<div class="container text-center">
<h4>Red-Cross Club Registration</h4>

<p><a href="https://lh3.googleusercontent.com/kUGo_RR3VjqWFlMsGUw-RfGLYdCmr30apMTn8-jaPWScWnrZyGtSYrLY4KLKybW7k41FbqS8iw=w200"><img alt="" src="{{asset('image/redcross.jpg')}}" style="width: 100px; height: 100px;"></a></p>
<p><span style="font-size:16px;">A <strong>Red Cross</strong> Club provides you and your peers opportunities to make a meaningful impact in your community by addressing its greatest needs, and develop leadership skills. Red Cross Clubs empower you with knowledge and life-saving skills to help prepare your school and community to respond to emergencies.</span></p>

<p><span style="font-size:16px;"><strong>ROLES OF RED CROSS CLUB</strong></span></p>
<p style="font-size:16px;">Your child can become a <strong>lifeguard</strong></p>
          <p style="font-size:16px;">Learn how to perform <strong>CPR</strong></p>
          <p style="font-size:16px;">Become a <strong>trained instructor</strong> who teaches others</p>
          <p style="font-size:16px;">They can organize <strong>blood drives</strong></p>
          <p style="font-size:16px;">Help <strong>U.S. military</strong> members</p>
          <p style="font-size:16px;">Help to eradicate <strong>measles</strong> and much more</p>

<p><span style="font-size:16px;"><strong>OBJECTIVES OF RED CROSS CLUB</strong></span></p>

<p><span style="font-size:16px;"> Reduce the number of deaths, injuries and impact from disasters.<br>
 Reduce the number of deaths, illnesses and impact from diseases and public health emergencies.<br>
 Increase local community, civil society and Red Cross Red Crescent capacity to address the most urgent situations of vulnerability.<br>
 Promote respect for diversity and human dignity, and reduce intolerance, discrimination and social exclusion.</span></p>

<p><span style="font-size:16px;"><strong>BENEFITS OF RED CROSS CLUB</strong></span></p>
<p style="font-size:16px;"><span > Diverse fields to work in (health and safety, armed forces, communications, etc)<br>
 Leadership positions at the club, chapter, and national level.<br>
 Access to a large array of resources.</span></p>
...
<form class="form-style shadow container" enctype="application/x-www-form-urlencoded" id="form-data" name="vm.form" ng-submit="vm.onSubmit()" novalidate="" style="height: 100%;" method="POST" action="{{route('redcrosses.store')}}">
  {{ csrf_field() }}
