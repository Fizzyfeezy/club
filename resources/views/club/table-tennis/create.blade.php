...
@section('title', '| Table-Tennis Club Form' )
...
<html><head><style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}</style><!-- Bootstrap core CSS -->
  ...
  <title>Table-Tennis Club form</title>
</head>
<body class="container" ng-app="demoApp" ng-controller="MainCtrl as vm" style="overflow-x: hidden">
<div class="container text-center">
<h4>Table-Tennis Club Registration</h4>

<p><a href="https://lh3.googleusercontent.com/kUGo_RR3VjqWFlMsGUw-RfGLYdCmr30apMTn8-jaPWScWnrZyGtSYrLY4KLKybW7k41FbqS8iw=w200"><img alt="" src="{{asset('image/table.jpg')}}" style="width: 100px; height: 100px;"></a></p>
<p><span style="font-size:16px;">In table tennis (or ping-pong, as it is often called colloquially), two opponents (in singles) or two teams of two opponents (in doubles), play a match consisting of games and points, using wooden-based rackets covered in rubber to hit a 40mm diameter celluloid ball over a 15.25cm high net, onto the opponent's side of a table that is 2.74m long and 1.525m wide, and 76cm high.<br>

The overall objective of the game of ping-pong is to win the match by winning enough points to win more than half of the number of maximum possible games to be played between you and your opponent (in singles), or you, your partner and your two opponents (in doubles).</span></p>

<p><span style="font-size:16px;"><strong>OBJECTIVES OF TABBLE-TENNIS CLUB</strong></span></p>

<p><span style="font-size:16px;">- First of all to involve children in table tennis as a sport, with emphasis on fitness and competitive skills.<br>
- To give the children, and also their parents, a positive feeling of social belonging to a sound, safe and pleasant environment.<br>
- Attract and look after children with indigenous background as well as other children.<br>
- Also be an attractive alternative for adult players.<br>
- To be a better alternative because of better coaching, better competitions and better ability to look after the players</span></p>

<p><span style="font-size:16px;"><strong>BENEFITS OF TABLE-TENNIS CLUB</strong></span></p>
<p><span style="font-size:16px;">
 Playing improves hand-eye coordination and it stimulates mental alertness, concentration and tactical strategy<br>
 Develops mental acuity.<br>
 Improves reflexes.<br>
 Keeps your brain sharp.<br>
 Improve balance an coordination</span></p>
...
<form class="form-style shadow container" enctype="application/x-www-form-urlencoded" id="form-data" name="vm.form" ng-submit="vm.onSubmit()" novalidate="" style="height: 100%;" method="POST" action="{{route('tables.store')}}">
  {{ csrf_field() }}
