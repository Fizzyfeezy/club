...
@section('title', '| Ballet Club Form' )
...
<html><head><style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}</style><!-- Bootstrap core CSS -->
  ...
  <title>Ballet Club form</title>
</head>
<body class="container" ng-app="demoApp" ng-controller="MainCtrl as vm" style="overflow-x: hidden">
<div class="container text-center">
<h4>Ballet Club Registration</h4>

<p><a href="https://lh3.googleusercontent.com/kUGo_RR3VjqWFlMsGUw-RfGLYdCmr30apMTn8-jaPWScWnrZyGtSYrLY4KLKybW7k41FbqS8iw=w200"><img alt="" src="{{asset('image/ballet.jpg')}}" style="width: 100px; height: 100px;"></a></p>
<p><span style="font-size:16px;">The Ballet Club offers students a foundation of life skills; physical health, intellectual stimulation, confidence, discipline, and fun!<br>Physical activity is an essential component of a healthy lifestyle, and ballet is a fabulous form of exercise that is unparalleled in terms of its thoroughness. New York City children today have even less opportunity to move than children living in New York City in the 1970s. Children walk less today and in many cases do not have daily gym class. Television, video games, and the internet have replaced physical activities during playtime.<br>Ballet requires extreme precision. This in turn requires the student to learn the value of patience, persistence, and perseverance. The complexity of ballet technique teaches organizational skills and lends itself to creating order in life. Most of all, ballet training develops tremendous concentration skills. To succeed in ballet, students must train themselves to focus, shutting out extraneous distractions.<br>Ballet requires thinking with both sides of the brain. It develops strong creative thinking skills, mental multitasking skills, and imagination. The Children’s Creative Dance Club Division and The Performing Arts Pre-Professional Division at The Ballet Club in New York City emphasize mathematical skills to students through the use of spatial relationships, music, and rhythm. Quick memorization of sequences is essential.</span></p>

<p><span style="font-size:16px;"><strong>OBJECTIVES OF BALLET CLUB</strong></span></p>

<p><span style="font-size:16px;"> To create and maintain interest and love for ballet among learners.<br>
 To develop a multifaceted physicality through training in dance techniques.<br>
 Participation in rehearsal and performance process and collaborating with others.<br>
 Studying and practice methodologies for translating written text and song into live performance.<br>
 To integrate dance with choreography.<br>
 To expose learners to competitions and presentations of ballet within and outside the school.</span></p>

<p><span style="font-size:16px;"><strong>BENEFITS OF BALLET CLUB</strong></span></p>
<p><span style="font-size:16px;"> Enhances physical, emotional and social skills.<br>
 Personal development of skills and discovery of innate abilities.<br>
 Instils the love of learning and growing.<br>
 Internalisation of confidence and boldness in learners.<br>
 Exposure within and outside school through presentations, competitions and outings.</span></p>
...
<form class="form-style shadow container" enctype="application/x-www-form-urlencoded" id="form-data" name="vm.form" ng-submit="vm.onSubmit()" novalidate="" style="height: 100%;" method="POST" action="{{route('ballets.store')}}">
  {{ csrf_field() }}
