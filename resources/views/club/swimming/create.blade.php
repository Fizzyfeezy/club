...
@section('title', '| Swimming Club Form' )
...
<html><head><style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}</style><!-- Bootstrap core CSS -->
  ...
  <title>Swimming Club form</title>
</head>
<body class="container" ng-app="demoApp" ng-controller="MainCtrl as vm" style="overflow-x: hidden">
<div class="container text-center">
<h4>Swimming Club Registration</h4>

<p><a href="https://lh3.googleusercontent.com/kUGo_RR3VjqWFlMsGUw-RfGLYdCmr30apMTn8-jaPWScWnrZyGtSYrLY4KLKybW7k41FbqS8iw=w200"><img alt="" src="{{asset('image/swimming.jpg')}}" style="width: 100px; height: 100px;"></a></p>
<p><span style="font-size:16px;">Swimming provides numerous physical and personal benefits. Fitness, strength, co-ordination and physical awareness, are just a few of the advantages that are gained by swimming regularly.
The sport, discipline and commitment of swimming also challenges and develops many personal skills.<br>
Swimming is a life-skill. Maccabi AJAX Swimming Club recommends that children and adults alike are taught the basic skills of survival in the water. Through quality swim programs, members can train and race with the aim of attaining their goals via a structured athletic pathway.</span></p>

<p><span style="font-size:16px;"><strong>OBJECTIVES OF SWIMMING CLUB</strong></span></p>

<p><span style="font-size:16px;"> To foster and develop Swimming, Water Polo and Masters Swimming and other water related activities and its participants.<br>
 To promote the teaching/coaching of these activities in line with current best practice.<br>
 To promote the development of physical, moral and social qualities associated with sport, within the participants.<br>
 To accept and enforce the rules and regulations set down by Swim Ireland regarding Swimming, Water Polo and Masters Swimming in accordance with the affiliation status afforded to the Club.<br>
 To provide a positive and safe environment for all its members and staff.<br>
 To ensure sport for young people in the club is fun, and conducted in an encouraging atmosphere in line with Swim Ireland guidelines and best practice.<br>
 To provide equal opportunities whenever possible for successful participation, irrespective of ability or disability, so as individuals can be involved in sports activities in an integrated and inclusive way.</span></p>

<p><span style="font-size:16px;"><strong>BENEFITS OF SWIMMING CLUB</strong></span></p>
<p><span style="font-size:16px;"> As well as being fun, swimming is a great way to keep fit and well and make friends.<br>
 Swimming is a healthy activity that you can continue for a lifetime.<br>
 Swimming is a low-impact activity that has many physical and mental health benefits.<br>
 Make sure you know how to swim and do so in a safe environment.</span></p>
...
<form class="form-style shadow container" enctype="application/x-www-form-urlencoded" id="form-data" name="vm.form" ng-submit="vm.onSubmit()" novalidate="" style="height: 100%;" method="POST" action="{{route('swimmings.store')}}">
  {{ csrf_field() }}
