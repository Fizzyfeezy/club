...
@section('title', '| Basketball Club Form' )
...
<html><head><style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}</style><!-- Bootstrap core CSS -->
  ...
  <title>Basketball Club form</title>
</head>
<body class="container" ng-app="demoApp" ng-controller="MainCtrl as vm" style="overflow-x: hidden">
<div class="container text-center">
<h4>Basketball Club Registration</h4>

<p><a href="https://lh3.googleusercontent.com/kUGo_RR3VjqWFlMsGUw-RfGLYdCmr30apMTn8-jaPWScWnrZyGtSYrLY4KLKybW7k41FbqS8iw=w200"><img alt="" src="{{asset('image/basket.jpg')}}" style="width: 100px; height: 100px;"></a></p>
<p><span style="font-size:16px;">Basketball is a team sport in which two teams, most commonly of five players each, opposing one another on a rectangular court, compete with the primary objective of shooting a basketball (approximately 9.4 inches (24 cm) in diameter) through the defender's hoop (a basket 18 inches (46 cm) in diameter mounted 10 feet (3.048 m) high to a backboard at each end of the court) while preventing the opposing team from shooting through their own hoop.</span></p>

<p><span style="font-size:16px;"><strong>OBJECTIVES OF BASKETBALL CLUB</strong></span></p>

<p><span style="font-size:16px;">1. To develop an understanding of the importance of sport in the pursuit of a healthy lifestyle.<br>

2. To develop a person’s self-esteem and self-confidence through their sporting experiences.<br>

3. To develop the concepts of fair play, honest competition and good sportsmanship among the team members.<br>

4. To develop an individual’s physical fitness by maintaining and increasing such components as speed, flexibility, muscular, strength, muscular endurance, aerobic capacity and anaerobic capacity.<br>

5. To motivate player who wants to improve and further develop their fundamental skills of playing basketball.</span></p>

<p><span style="font-size:16px;"><strong>BENEFITS OF JETS CLUB</strong></span></p>
<p><span style="font-size:16px;"><strong>Physical Benefits</strong>
It’s no secret that being physically active is an important part of leading a healthy and fulfilling lifestyle. Basketball is a fast-moving game where your heart rate is constantly increased, helping to not only reduce the risk of heart disease or a stroke later in life but also reduce emotional and mental health issues such as anxiety and depression. Playing basketball regularly is great for your overall general health and, being a high-intensity game, also burns a lot more calories than some other weight bearing exercises..<br>
<strong>Mental Benefits</strong>
Basketball also has great benefits for mental cognition and health. Players need to be constantly thinking and aware of what moves to make, where other players are on the court and how to cope and react under pressure. Additionally, mental improvements are also enhanced, as playing basketball helps to improve motor skills and coordination, boosts self-image, reduces stress and improves sleeping habits. All these aspects help assist adults in living a healthy lifestyle.<br>
<strong>Social Benefits</strong>
There are a number of social benefits that come from playing basketball. Playing basketball gives players a sense of being part of a team and allows them to connect and have fun with teammates. Basketball is all about teamwork and provides the opportunity to deal with different types of people from different backgrounds and social groups in order to collaborate and foster a great team environment. Whether you just want to play for fun or on a competitive level, basketball is a great team building sport.
</span></p>
...
<form class="form-style shadow container" enctype="application/x-www-form-urlencoded" id="form-data" name="vm.form" ng-submit="vm.onSubmit()" novalidate="" style="height: 100%;" method="POST" action="{{route('baskets.store')}}">
  {{ csrf_field() }}
...
<div class="col-xs-12 col-sm-6 col-md-6" ng-class="{'has-error': showError}"><label class="control-label " style="color: rgb(12, 12, 12)"><h3 id="amount" style="margin-top: 50px;">Payment : 5000</h3></label></div>
</div>
