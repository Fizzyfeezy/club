...
<html><head><style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}</style><!-- Bootstrap core CSS -->
  ...
  <title>Press Club form</title>
</head>
<body class="container" ng-app="demoApp" ng-controller="MainCtrl as vm" style="overflow-x: hidden">
<div class="container text-center">
<h4>Press Club Registration</h4>

<p><a href="https://lh3.googleusercontent.com/kUGo_RR3VjqWFlMsGUw-RfGLYdCmr30apMTn8-jaPWScWnrZyGtSYrLY4KLKybW7k41FbqS8iw=w200"><img alt="" src="{{asset('image/press.png')}}" style="width: 100px; height: 100px;"></a></p>
<p><span style="font-size:16px;">A press club is an organization for journalists and others professionally engaged in the production and dissemination of news. The press generally has to do with gathering, evaluating and distributing facts of current interest. it makes use of reporters, learners in this case, who research and write stories to be presented during school assemblies or to be posted on boards often with the guidance teacher as editors.such news, in most cases consists of events that have happened in the school, the current ones, and those still on the pipeline.</span></p>

<p><span style="font-size:16px;"><strong>OBJECTIVES OF PRESS CLUB</strong></span></p>

<p><span style="font-size:16px;">1. to protect and preserve the legal and constitutional rights of journalist members through reasonable and justified means.<br>

2. to provide members means of professional, educational, social, cultural and recreational activities and to establish, maintain and conduct a Club for the use and benefit of members, their families and guests, and maintain a Club house.<br>

3. to open and maintain Club branches in more than one location within the union territory of Delhi.<br>

4. to provide, as may be feasible and convenient, facilities such as reading room, library, health club, gym, swimming pool, community hall/center etc for the use of members.<br>
...
<p><span style="font-size:16px;"><strong>BENEFITS OF PRESS CLUB</strong></span></p>
<p><span style="font-size:16px;"> <strong>National Press Club</strong> – access to the nation’s preeminent press club in Washington, D.C. included privileges for dining, accommodations, amenities and programs<br>
 <strong>Touchstones</strong> – the Press Club’s annual evening reception and award ceremony to recognize excellence in local journalism, community contributions, community lifetime achievement, and lifetime contributions to journalism.<br>
 <strong>Pressing Issues</strong> – forum/discussion programs organized around timely and high-profile topics driven by the news of the day.  Is it appropriate to broadcast close-up video from a wrong-way crash?  Do the media cover the gun control debate fairly?  Panelists representing the newsroom, classroom, boardroom, and living room debate the issues and invite audience response.<br>
 <strong>After hours networking</strong> – quarterly social activities at some of the area’s most popular drinking establishments that bring reporters, editors and producers from all local media to meet each other – and the people that they cover.</span></p>
...
<form class="form-style shadow container" enctype="application/x-www-form-urlencoded" id="form-data" name="vm.form" ng-submit="vm.onSubmit()" novalidate="" style="height: 100%;" method="POST" action="{{route('presses.store')}}">
  {{ csrf_field() }}
