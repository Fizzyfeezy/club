...
@section('title', '| Karate Club Form' )
...
<html><head><style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}</style><!-- Bootstrap core CSS -->
  ...
  <title>Karate Club form</title>
</head>
<body class="container" ng-app="demoApp" ng-controller="MainCtrl as vm" style="overflow-x: hidden">
<div class="container text-center">
<h4>Karate Club Registration</h4>

<p><a href="https://lh3.googleusercontent.com/kUGo_RR3VjqWFlMsGUw-RfGLYdCmr30apMTn8-jaPWScWnrZyGtSYrLY4KLKybW7k41FbqS8iw=w200"><img alt="" src="{{asset('image/karate.jpg')}}" style="width: 100px; height: 100px;"></a></p>
<p><span style="font-size:16px;">In traditional karate victory is not an ultimate aim. Tradition karate is an art of self-defence which uses only and in the most efficient way human body. It employs mainly blocking, blowing, punching and kicking techniques?<br>
The purpose of Traditional Karate is to develop well-balanced mind and body, through training in fighting techniques. Traditional Karate also shares the ultimate aim with Budo, which is to cultivate great human character of a higher class that prevents any violent attack before an actual fight occurs.<br>

Budo originates in the practice of physical fighting; however, it has a significant effect on the spiritual and physical development of a human since Budo philosophy and ethics are absolute requirements for the study of techniques and improvement of skills. Elements such as manners and etiquette were not adapted from outside elements nor are they independent from the physical training, but existed within the system since the origin of Budo and were integrated to the technical improvement:</span></p>


<p><span style="font-size:16px;"><strong>OBJECTIVES OF KARATE CLUB</strong></span></p>

<p><span style="font-size:16px;"> Seriousness<br>
 Humility<br>
 Calmness and Discipline<br>
 Skilfulness</span></p>

<p><span style="font-size:16px;"><strong>BENEFITS OF KARATE CLUB</strong></span></p>
<p><span style="font-size:16px;">1. Increased Mobility<br>2. Improved Flexibility, Strenght and power.<br>
3. Improved Stability and Coordination<br>4. Lowered Blood Pressure and Heart Rate<br>
5. Mental Concentration and stress relief</span></p>
...
<form class="form-style shadow container" enctype="application/x-www-form-urlencoded" id="form-data" name="vm.form" ng-submit="vm.onSubmit()" novalidate="" style="height: 100%;" method="POST" action="{{route('karates.store')}}">
  {{ csrf_field() }}
