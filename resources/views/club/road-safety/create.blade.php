...
@section('title', '| Road-Safety Club Form' )
...
<html><head><style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}</style><!-- Bootstrap core CSS -->
  ...
  <title>Road-Safety Club form</title>
</head>
<body class="container" ng-app="demoApp" ng-controller="MainCtrl as vm" style="overflow-x: hidden">
<div class="container text-center">
<h4>Road Safety Club Registration</h4>

<p><a href="https://lh3.googleusercontent.com/kUGo_RR3VjqWFlMsGUw-RfGLYdCmr30apMTn8-jaPWScWnrZyGtSYrLY4KLKybW7k41FbqS8iw=w200"><img alt="" src="{{asset('image/road.jpg')}}" style="width: 100px; height: 100px;"></a></p>
<p><span style="font-size:16px;">Road safety club was established as a means of teaching the younger generations with a view to inculcating good road
behavior.
The Road Safety Club constitutes the third tier of the road safety Corps, Regular Marshals/Special Marshals. Levels of RSC,
these are NYSC, Primary and Secondary schools.
The commission used the club as a ‘Catch them Young’ strategy.
In order to drive home the sage Road Culture, the Corps Partnered with the NYSC to have road safety as one of the CDS
groups during the one year service.While the clubs are established in primary and secondary schools with weekly trainings and
different activities to continually en-sage the youth.
</span></p>

<p><span style="font-size:16px;"><strong>OBJECTIVES OF ROAD-SAFETY CLUB</strong></span></p>

<p><span style="font-size:16px;">i. To inculcate into the youths Road Safety Culture as contained in the Highway Code and other relevant road safety
books and journals, films etc as approve by the Corps.<br>
ii. To assist in propagating road safety ideals and ethics to compliment the effects of Regular and Special Marshals.<br>
iii. To monitor and report back to the appropriate FRSC office conditions of road.<br>
iv. Reports Road Crash to the nearest FRSC office or any relevant body for assistance.<br>
v. To organize workshops, rallies, public enlightenment campaign, seminars, quiz and debate competitions and any other
programme relevant to the promotion of Road Safety.
</span></p>

<p><span style="font-size:16px;"><strong>BENEFITS OF ROAD-SAFETY CLUB</strong></span></p>
<p><span style="font-size:16px;">Our safety club is a proven and effective road safety programme, with a focus in helping parents/ carers teach their children how to keep safe when out and about in a fun way.<br>
As a member of the club, children are equipped with materials to help them learn lifesaving messages. The road safety club has been a huge success and still on going in collaboration with the Federal Road Safety Commission (FRSC). We are very proud that it remains the most effective road safety education programme in Nigeria, because some life habits of children can be set between the ages of 3-5 years old. So this is the vital time to introduce them to the club……. See More [Pictures]</span></p>
...
<form class="form-style shadow container" enctype="application/x-www-form-urlencoded" id="form-data" name="vm.form" ng-submit="vm.onSubmit()" novalidate="" style="height: 100%;" method="POST" action="{{route('roads.store')}}">
  {{ csrf_field() }}
...
<div class="col-xs-12 col-sm-6 col-md-6" ng-class="{'has-error': showError}"><label class="control-label " style="color: rgb(12, 12, 12)"><h3 id="amount" style="margin-top: 50px;">Payment : 3000</h3></label></div>
</div>
