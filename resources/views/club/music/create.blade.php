...
<html><head><style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}</style><!-- Bootstrap core CSS -->
  ...
  <title>Music Club form</title>
</head>
<body class="container" ng-app="demoApp" ng-controller="MainCtrl as vm" style="overflow-x: hidden">
<div class="container text-center">
<h4>Music Club Registration</h4>

<p><a href="https://lh3.googleusercontent.com/kUGo_RR3VjqWFlMsGUw-RfGLYdCmr30apMTn8-jaPWScWnrZyGtSYrLY4KLKybW7k41FbqS8iw=w200"><img alt="" src="{{asset('image/music.jpg')}}" style="width: 100px; height: 100px;"></a></p>
<p><span style="font-size:16px;">The Music Club serves as a platform for peers to bond over music, in terms of performing, collaborating, learning, sharing, exploring and creating, by assimilating the vast and diverse tastes present in such a culturally charged setting. It is a place where students can express themselves uninhibitedly, relieve stress and build long-lasting memories to cherish forever.
As a social club, we provide an opportunity to students to showcase their musical talent at the countless events that happen on campus, as well as off campus at major venues in the city.</span></p>

<p><span style="font-size:16px;"><strong>OBJECTIVES OF JETS CLUB</strong></span></p>

<p><span style="font-size:16px;">1) Promote the highest levels of human aspiration and artistic integrity through the composition, documentation, and performance of music.<br>

2) Develop an analytical, creative, and intuitive understanding of music as a cultural language.<br>

3) Afford students opportunities for cultural and aesthetic experiences through active participation in music, enhance their understanding and appreciation of the arts, and foster interaction between music and the liberal arts.<br>

4) Enrich the campus and the region through concerts, workshops, and other public events, and provide opportunities for traditional and contemporary musical expression by students, faculty, guest artists, and members of the community.<br>

5) Serve the University System of Maryland, the state, and the nation as an internationally recognized center for cutting-edge research in contemporary art-music through creative work in music technology, composition, and performance.<br>

6) Promote and support student research and collaborations, often conducted jointly with faculty through publications and performances.<br>

7) Provide opportunities and guidance to prepare our students for a professional life in music through mentorship, internships, entrepreneurial experience, and training as educators.</span></p>

<p><span style="font-size:16px;"><strong>BENEFITS OF MUSIC CLUB</strong></span></p>
<p><span style="font-size:16px;"> Language, Math and Listening skills.<br> Improved test scores and Self esteem<br> Making the brain work harder.<br> Relieving stress and Creativity<br> Helping special needs children.<br> Higher graduation rates</span></p>
...
<form class="form-style shadow container" enctype="application/x-www-form-urlencoded" id="form-data" name="vm.form" ng-submit="vm.onSubmit()" novalidate="" style="height: 100%;" method="POST" action="{{route('musics.store')}}">
  {{ csrf_field() }}
