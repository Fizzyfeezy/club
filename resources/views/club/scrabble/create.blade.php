...
@section('title', '| Scrabble Club Form' )
...
<html><head><style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}</style><!-- Bootstrap core CSS -->
  ...
  <title>Scrabble Club form</title>
</head>
<body class="container" ng-app="demoApp" ng-controller="MainCtrl as vm" style="overflow-x: hidden">
<div class="container text-center">
<h4>Scrabble Club Registration</h4>

<p><a href="https://lh3.googleusercontent.com/kUGo_RR3VjqWFlMsGUw-RfGLYdCmr30apMTn8-jaPWScWnrZyGtSYrLY4KLKybW7k41FbqS8iw=w200"><img alt="" src="{{asset('image/scrabble.jpg')}}" style="width: 100px; height: 100px;"></a></p>
<p><span style="font-size:16px;">Scrabble Club is available to students in the Middle Phase: Years 6, 7 and 8. <br>
The broad aim of the Scrabble Club is to ensure that students have fun. Scrabble is a game for two, three or four players. Play consists of word building, using seven letters selected randomly; each letter tile has a score attached to it. The game can help students develop and practise spelling, as well as help to extend their vocabulary. The club also allows the students to interact with other students in the Middle Phase.<br>
So if you want to improve your spelling and vocabularyand have some fun during those break times, what are you waiting for? Come along! We run this twice a week with Miss Meryl and Mr Ivan..</span></p>

<p><span style="font-size:16px;"><strong>OBJECTIVES OF SCRABBLE CLUB</strong></span></p>

<p><span style="font-size:16px;"> The objectives of the Scrabble Club include imparting the skills and techniques in Scrabble games<br> Enthuse members in exploring the frontiers of words’ existence and meanings.<br> The sessions heighten members’ awareness in extent of the English lexicon (vocabulary).<br> Members forge friendships and learn to make informed decisions with emphasis on team wellness. <br> Through the CCA activities, members become confident and self-directed individuals who learn through scenarios, identifying risks and mitigating them in the course of the game.</span></p>

<p><span style="font-size:16px;"><strong>BENEFITS OF SCRABBLE CLUB</strong></span></p>
<p><span style="font-size:16px;"> The benefits of Scrabble include increased vocabulary, spelling and math skills as well as critical thinking skills, teamwork and sportsmanship. Through Scrabble clubs, students interact with dedicated mentors and a positive group of like-minded peers while building their skills. Provides training, materials, placement assistance for volunteers, and ongoing support for volunteers and site partners.</span></p>
...
<form class="form-style shadow container" enctype="application/x-www-form-urlencoded" id="form-data" name="vm.form" ng-submit="vm.onSubmit()" novalidate="" style="height: 100%;" method="POST" action="{{route('scrabbles.store')}}">
  {{ csrf_field() }}
...
<div class="col-xs-12 col-sm-6 col-md-6" ng-class="{'has-error': showError}"><label class="control-label " style="color: rgb(12, 12, 12)"><h3 id="amount" style="margin-top: 50px;">Payment : 6000</h3></label></div>
</div>
