...
@section('title', '| Science Club Form' )
...
<html><head><style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}</style><!-- Bootstrap core CSS -->
  ...
  <title>Science Club form</title>
</head>
<body class="container" ng-app="demoApp" ng-controller="MainCtrl as vm" style="overflow-x: hidden">
<div class="container text-center">
<h4> Science Club Registration</h4>

<p><a href="https://lh3.googleusercontent.com/kUGo_RR3VjqWFlMsGUw-RfGLYdCmr30apMTn8-jaPWScWnrZyGtSYrLY4KLKybW7k41FbqS8iw=w200"><img alt="" src="{{asset('image/science.png')}}" style="width: 100px; height: 100px;"></a></p>
<p><span style="font-size:16px;">Science Club is an afterschool, mentor-based science program for middle school youth. This program brings graduate student mentors together with small groups of students to conduct fun and engaging scientific investigations. <br><strong>The mentorship-based, science education model includes:</strong><br>A focus on longterm, academically-focused relationships between youth club members and practicing scientists.<br>
Hands-on science curricula, spanning topics like biomedical engineering, medicine, food science, environmental science, audiology, and neuroscience.<br>
A fun event at the end of each curricular unit where students share their work with friends and family.<br>
Rigorous evaluation and evidence-based methods designed to learn what's working (and what's not) and share it with the wider community.</span></p>

<p><span style="font-size:16px;"><strong>AIMS OF SCIENCE CLUB</strong></span></p>

<p><span style="font-size:16px;">1. To help students acquire basic knowledge of Science.<br>

2. To help students develop a scientific way of learning.<br>

3. To develop students' awareness of and concern for scientific issues in personal, social, environmental and technological contexts.</span></p>

<p><span style="font-size:16px;"><strong>OBJECTIVES OF SCIENCE CLUB</strong></span></p>

<p><span style="font-size:16px;">1. To arouse and cultivate students' interest in learning Science.<br>

2. To encourage student to participate actively in the activities organized by the Science Club.<br>

3. To promote the use of IT in learning Science.<br>

4. To understand scientific knowledge through experiments.
</span></p>

<p><span style="font-size:16px;"><strong>BENEFITS OF SCIENCE CLUB</strong></span></p>
<p><span style="font-size:16px;">Practice at the process skills needed in science.<br>
Increased opportunity to develop and practice thinking, speaking and listening skills.<br>
Opportunities to experience a wider range of science topics, hence broadening their enthusiasm for science.</span></p>
...
<form class="form-style shadow container" enctype="application/x-www-form-urlencoded" id="form-data" name="vm.form" ng-submit="vm.onSubmit()" novalidate="" style="height: 100%;" method="POST" action="{{route('sciences.store')}}">
  {{ csrf_field() }}
