...
@section('title', '| Brownie Club Form' )
...
<html><head><style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}</style><!-- Bootstrap core CSS -->
  ...
  <title>Brownie Club form</title>
</head>
<body class="container" ng-app="demoApp" ng-controller="MainCtrl as vm" style="overflow-x: hidden">
<div class="container text-center">
<h4>Brownie Club Registration</h4>

<p><a href="https://lh3.googleusercontent.com/kUGo_RR3VjqWFlMsGUw-RfGLYdCmr30apMTn8-jaPWScWnrZyGtSYrLY4KLKybW7k41FbqS8iw=w200"><img alt="" src="{{asset('image/brownie.jpeg')}}" style="width: 100px; height: 100px;"></a></p>
<p><span style="font-size:16px;">Brownie are also called <strong>Girls Scouts</strong>. Girl Scouts in the Brownie® program are ready to take on the world, and Girl Scouts lets them do just that! They want to learn new things and show off what they know. They want to explore the world and meet new people. And they want to do big things that make them feel great!
At Girl Scouts, she'll take that first hike in the great outdoors, visit a science museum, and band together as a mighty Brownie team to sell cookies (and use some of the money to help others). Life is good when you’re a Brownie!</span></p>

<p><span style="font-size:16px;"><strong>OBJECTIVES OF BROWNIE CLUB</strong></span></p>

<p><span style="font-size:16px;"> To provide a supportive and stimulating environment for students and staff.<br>
 To encourage all students to reach their full potential as independent learners and develop a positive attitude to life-long learning.<br>
 To foster the enjoyment of reading as a recreational activity in all members of the school.<br>
 To support The Grange School's curriculum by providing access to relevant resources for students and staff.<br>
 To provide resources (as appropriate) to support and develop the recreational interests of the students.<br>
 To provide the opportunities for the students to develop the knowledge and skills necessary to access library resources.<br>
 To develop an awareness in students of the importance of books and other resources as a means of recording and sharing human achievements, failures and aspirations.</span></p>

<p><span style="font-size:16px;"><strong>BENEFITS OF BROWNIE CLUB</strong></span></p>
<p><span style="font-size:16px;"> We offer a safe, welcoming girl-only space for girls and young women to try new things, help other people and discover their passions and talents. All while having fun with a group of ready-made friends!.<br>

 We're dedicated to girls leading the way - they choose activities, challenges and events that inspire them, and our volunteers support them to make it happen. Because girls shape and lead everything we do, we know that we're offering the best opportunities and experiences for girls today.<br>

 We're always updating and adapting our programme and resources so that they're relevant to girls today. For example, girls told us they wanted to talk about mental health, so we created Think Resilient - a resource delivered by our specially-trained Peer Educators to help build girls' resilience and wellbeing.</span></p>
...
<form class="form-style shadow container" enctype="application/x-www-form-urlencoded" id="form-data" name="vm.form" ng-submit="vm.onSubmit()" novalidate="" style="height: 100%;" method="POST" action="{{route('brownies.store')}}">
  {{ csrf_field() }}
...
<div class="col-xs-12 col-sm-6 col-md-6" ng-class="{'has-error': showError}"><label class="control-label " style="color: rgb(12, 12, 12)"><h3 id="amount" style="margin-top: 50px;">Payment : 4000</h3></label></div>
</div>
